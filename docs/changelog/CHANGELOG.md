...
Fourth release candidate for the Team Kitty 4.x cold-start walkthrough. This
candidate includes the Windows runtime repair; release and Kent's Windows 11
smoke test remain subject to the gates in planning#1999.
