...
# 2. Manual workflow lint (no CI gate exists for these)
...
Record the passed/failed counts + the actionlint/shellcheck 0-finding result in the PR body.
...
| SC-004 lint clean | `actionlint`/`shellcheck` | 0 findings | _pre-merge_ |
