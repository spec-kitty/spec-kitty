...
- 2026-09-26 — Operator: never run the full `tests/architectural/` suite (wasteful); WP11/tasks/plan switched to targeted architectural gate files; running agents notified.
