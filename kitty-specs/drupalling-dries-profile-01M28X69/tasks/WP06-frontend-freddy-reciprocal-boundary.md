...
1. **Read Dries's boundary first.** Open
   `packs/built-in/agent_profiles/drupalling-dries.agent.yaml` (WP02's output) and read
...
2. Add one clause to Freddy's `avoidance-boundary`, in the existing voice:
   ...
   > render arrays and preprocess functions (deferred to Drupalling Dries)
...
**Validation**:
- [ ] Drupalling Dries named explicitly
...
- [ ] Drupalling Dries named by name
