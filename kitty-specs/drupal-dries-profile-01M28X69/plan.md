# Implementation Plan: Drupal Dries Agent Profile

**Branch**: `feat/drupal-dries-profile` | **Date**: 2026-09-11 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `kitty-specs/drupal-dries-profile-01M28X69/spec.md`

## Summary

Add **Drupal Dries**, a Drupal-specialist implementer, delivered as a complete specialist
...
```
kitty-specs/drupal-dries-profile-01M28X69/
├── plan.md              # This file
...
packs/built-in/
├── agent_profiles/
│   ├── drupal-dries.agent.yaml            # NEW  — the profile
...
```mermaid
flowchart TD
    A["drupal-dries.agent.yaml<br/>declares directive-references<br/>+ tactic-references"] --> E["DRG extractor"]
