...
-> ``apps.live_capability.relay_auth.observer_headers``: shared-token
bearer plus a freshly minted ``observer``-kind capability -- the pull
surface the live panel folds on every request, #168 option (a)).
