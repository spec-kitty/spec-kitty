"""WP01/T005 — failing verification for the drupal-dries DRG lineage.

Mission ``drupal-dries-profile-01M28X69``. RED half of red-first
discipline: none of the ``drupal-dries`` graph nodes/edges exist yet, so
...
_DRIES = "agent_profile:drupal-dries"
...
class TestEndpointFormAndAcyclicity:
    ...
    def test_specializes_from_subgraph_remains_acyclic(self, graph: DRGGraph) -> None:
        """A leaf edge from drupal-dries to implementer-ivan cannot introduce
